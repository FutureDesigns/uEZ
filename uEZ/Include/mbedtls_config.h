...
#define ENABLE_TLS_1P3_AND_OPTIONS 0 // TODO use this to toggle multiple options at once for TSL13.
...
#define MBEDTLS_SSL_PROTO_TLS1_3 // may be broken currently
#endif
 ...
 *
 */
#define MBEDTLS_SSL_MAX_EARLY_DATA_SIZE        1024 //required for TSL13 on 3.4
 ...
 *
 */
#define MBEDTLS_SSL_TLS1_3_TICKET_AGE_TOLERANCE 90000 // required for TLS1.3 build on 3.4
