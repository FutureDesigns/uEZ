 ...
 */
//#define MBEDTLS_ECP_RESTARTABLE // We get farther into handshake with this enabled, Renesas example doesn't use this
 ...
 * This option has no effect when #MBEDTLS_PSA_CRYPTO_C is disabled.
 */
#define MBEDTLS_PSA_KEY_SLOT_COUNT 64 // increase for use with PSA interface and TLS 1.3
