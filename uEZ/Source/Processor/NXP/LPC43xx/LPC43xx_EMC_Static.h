/*-------------------------------------------------------------------------*
 * File:  LPC43xx_EMC_Static.h
 *-------------------------------------------------------------------------*
 * Description:
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC43xx_EMC_STATIC_H_
#define LPC43xx_EMC_STATIC_H_
...
} T_LPC43xx_EMC_Static_MemoryWidth;

typedef struct {
        // Base address for this static memory area.  For the LPC43xx,
        ...
        // Bit width
        T_LPC43xx_EMC_Static_MemoryWidth iBitWidth;
...
} T_LPC43xx_EMC_Static_Configuration;
...
#endif // LPC43xx_EMC_STATIC_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC43xx_EMC_Static.h
 *-------------------------------------------------------------------------*/
