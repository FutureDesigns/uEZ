/*-------------------------------------------------------------------------*
 * File:  LPC546xx_EMC_Static.h
 *-------------------------------------------------------------------------*
 * Description:
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC546xx_EMC_STATIC_H_
#define LPC546xx_EMC_STATIC_H_
...
} T_LPC546xx_EMC_Static_MemoryWidth;

typedef struct {
        // Base address for this static memory area.  For the LPC546xx,
        ...
        // Bit width
        T_LPC546xx_EMC_Static_MemoryWidth iBitWidth;
...
} T_LPC546xx_EMC_Static_Configuration;
...
#endif // LPC546xx_EMC_STATIC_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC546xx_EMC_Static.h
 *-------------------------------------------------------------------------*/
