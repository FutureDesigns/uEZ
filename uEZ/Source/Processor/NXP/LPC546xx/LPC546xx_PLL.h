 ...
 *-------------------------------------------------------------------------*/
#ifndef LPC546xx_PLL_H_
#define LPC546xx_PLL_H_
 ...
 * Constants:
 *-------------------------------------------------------------------------*/
#define LPC546xx_IRC_FREQUENCY       12000000 // Hz +/- 1%

/*-------------------------------------------------------------------------*
 * Types:
 *-------------------------------------------------------------------------*/
typedef enum {
    LPC546xx_CLKSRC_SELECT_INTERNAL_RC = 0,
    LPC546xx_CLKSRC_SELECT_MAIN_OSCILLATOR = 1
} T_LPC546xx_ClockSourceSelect;

typedef enum {
    // sysclk
    LPC546xx_CPU_CLOCK_SELECT_SYSCLK = 0,

    // pll_clk
    LPC546xx_CPU_CLOCK_SELECT_PLL_CLK = 1,
} T_LPC546xx_CPUClockSelect;

typedef enum {
    // sysclk
    LPC546xx_USB_CLOCK_SELECT_SYSCLK = 0,

    // pll_clk
    LPC546xx_USB_CLOCK_SELECT_PLL_CLK = 1,

    // alt_pll_clk
    LPC546xx_USB_CLOCK_SELECT_ALT_PLL_CLK = 2,
} T_LPC546xx_USBClockSelect;

typedef enum {
    LPC546xx_CLOCK_OUT_SELECT_CPU = 0,
    LPC546xx_CLOCK_OUT_SELECT_MAIN_OSC = 1,
    LPC546xx_CLOCK_OUT_SELECT_IRC_OSC = 2,
    LPC546xx_CLOCK_OUT_SELECT_USB = 3,
    LPC546xx_CLOCK_OUT_SELECT_RTC = 4,
    LPC546xx_CLOCK_OUT_SELECT_WATCHDOG = 6,
} T_LPC546xx_ClockOutSelect;
...
typedef struct {
        ...
        // Selectors:
        T_LPC546xx_ClockSourceSelect iClockSourceSelect;
        T_LPC546xx_CPUClockSelect iCPUClockSelect;
        T_LPC546xx_USBClockSelect iUSBClockSelect;
        ...
        // CLK OUT selection:
        T_LPC546xx_ClockOutSelect iClockOutSelect;
        TUInt8 iClockOutDivider; // 1-16
        TBool iClockOutEnable;
} T_LPC546xx_PLL_Frequencies;
...
#endif // LPC546xx_PLL_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC546xx_PLL.h
 *-------------------------------------------------------------------------*/
