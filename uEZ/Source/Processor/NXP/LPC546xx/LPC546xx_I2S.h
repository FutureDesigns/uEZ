 ...
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC546xx_I2S_H_
#define LPC546xx_I2S_H_
...
} T_LPC546xx_I2S_Settings;

/*-------------------------------------------------------------------------*
 * Prototypes:
 *-------------------------------------------------------------------------*/
//extern const HAL_I2S G_LPC546xx_I2S_Interface;
void LPC546xx_I2S_Require(const T_LPC546xx_I2S_Settings *aSettings);

#endif // LPC546xx_I2S_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC546xx_I2S.h
 *-------------------------------------------------------------------------*/
