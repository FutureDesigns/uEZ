 ...
 * Function Prototypes:
 *---------------------------------------------------------------------------*/
extern void LPC1768_InterruptProcess_USBDevice(void);
extern void LPC1768_InterruptProcess_USBHost(void);

/*---------------------------------------------------------------------------*
 * Routine:  ILPC1768_USB_InterruptVector
 *---------------------------------------------------------------------------*
 * Description:
 *      Interrupt Vector routine that handles both USB device and USB host
 *      (if they are compiled in)
 *---------------------------------------------------------------------------*/
IRQ_ROUTINE(ILPC1768_USB_InterruptVector)
{
    IRQ_START();
