/*-------------------------------------------------------------------------*
 * File:  LPC2478_EMC_Static.h
 *-------------------------------------------------------------------------*
 * Description:
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC2478_EMC_STATIC_H_
#define LPC2478_EMC_STATIC_H_
...
} T_LPC2478_EMC_Static_MemoryWidth;

typedef struct {
        // Base address for this static memory area.  For the LPC2478,
        ...
        // Bit width
        T_LPC2478_EMC_Static_MemoryWidth iBitWidth;
...
} T_LPC2478_EMC_Static_Configuration;
...
#endif // LPC2478_EMC_STATIC_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC2478_EMC_Static.h
 *-------------------------------------------------------------------------*/
