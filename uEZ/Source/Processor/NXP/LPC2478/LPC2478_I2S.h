 ...
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC2478_I2S_H_
#define LPC2478_I2S_H_
...
} T_LPC2478_I2S_Settings;
/*-------------------------------------------------------------------------*
 * Prototypes:
 *-------------------------------------------------------------------------*/
extern const HAL_I2S G_LPC2478_I2S_Interface;
void LPC2478_I2S_Require(const T_LPC2478_I2S_Settings *aSettings);

#endif // LPC2478_I2S_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC2478_I2S.h
 *-------------------------------------------------------------------------*/
