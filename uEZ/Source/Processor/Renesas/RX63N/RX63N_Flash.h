...
*******************************************************************************/
#ifndef RX63N_FLASH_H
#define RX63N_FLASH_H
...
/* Below is memory information that is specific to device families (RX610,
   RX63N, etc...).  While memory sizes will differ between family members,
...
/* a different memory layout                                               */
    ...
    */
    ...
    #define DEFINE_ROM_ADDR_LOOKUP const uint32_t rom_block_addresses[38] = { \
    ...
    #define DF_START_ADDR   0x00100000
