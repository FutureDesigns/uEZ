/*-------------------------------------------------------------------------*
 * File:  uEZProcessor_RX62N.h
 *-------------------------------------------------------------------------*
 * Description:
 *     
 *-------------------------------------------------------------------------*/

#ifndef UEZPROCESSOR_RX62N
#define UEZPROCESSOR_RX62N
...
#define GPIO_P04       UEZ_GPIO_PORT_PIN(UEZ_GPIO_PORT_0, 4)
#define GPIO_P05       UEZ_GPIO_PORT_PIN(UEZ_GPIO_PORT_0, 5)
#define GPIO_P06       UEZ_GPIO_PORT_PIN(UEZ_GPIO_PORT_0, 6)
...
#endif // UEZPROCESSOR_RX62N
/*-------------------------------------------------------------------------*
 * End of File:  uEZProcessor_RX62N.h
 *-------------------------------------------------------------------------*/