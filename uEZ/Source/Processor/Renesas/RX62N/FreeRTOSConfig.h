...
#define configASSERT( x ) if( ( x ) == 0 ) { UEZBSP_FatalError(25); }

//extern volatile unsigned long ulHighFrequencyTickCount;
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() nop()
#define portGET_RUN_TIME_COUNTER_VALUE() UEZTickCounterGet()
