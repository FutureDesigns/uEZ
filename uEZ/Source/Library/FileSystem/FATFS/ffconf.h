...
#ifndef DISABLE_FILESYSTEM_WRITE_SUPPORT
    #define DISABLE_FILESYSTEM_WRITE_SUPPORT       0
#endif

#ifndef DISABLE_FILESYSTEM_FORMAT_SUPPORT
    #define DISABLE_FILESYSTEM_FORMAT_SUPPORT       0
#endif
...
#define FF_USE_FASTSEEK	0 // Should save small amount of code space.
#else
#define FF_USE_FASTSEEK	1 // Requires assigning a buffer to each file after opening it. Doesn't improve video player noticeably.
#endif
...
#define FF_MAX_SS		512 // 4096 TODO test
...
// Note that Sandisk/Western Digital Industrial microSD has some built-in automatic TRIM support.
...
#define FF_NORTC_MON	10 // Don't have any leading zeroes in these!
