...
T_glyphError GlyphCommOpen(T_glyphHandle aHandle, int32_t aAddress)
{
    ...
    switch (aAddress) {
		case 0:
             p_gw->iCommAPI->iOpen        	= Glyph_uEZ_Open;
             p_gw->iCommAPI->iCommandSend 	= Glyph_uEZ_CommandSend;
             p_gw->iCommAPI->iDataSend    	= Glyph_uEZ_DataSend;
		break;
