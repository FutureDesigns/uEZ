...
typedef struct {
    ...
    PACK_STRUCT_FIELD(TUInt16 h);
}PACK_STRUCT_STRUCT rfbRectangle;
PACK_STRUCT_END
...
typedef struct {
    ...
    PACK_STRUCT_FIELD(TUInt8 trueColour);
    /** If false then we need a "colour map" to
     convert pixels to RGB.  If true, xxxMax and
     xxxShift specify bits used for red, green
     and blue */
    /** the following fields are only meaningful if trueColour is true */
    PACK_STRUCT_FIELD(TUInt16 redMax);
    /** maximum red value (= 2^n - 1 where n is the
     number of bits used for red). Note this
     value is always in big endian order. */
    PACK_STRUCT_FIELD(TUInt16 greenMax);
    /** similar for green */

    PACK_STRUCT_FIELD(TUInt16 blueMax);
    /** and blue */

    PACK_STRUCT_FIELD(TUInt8 redShift);
    ...
    PACK_STRUCT_FIELD(TUInt8 greenShift); /** similar for green */

    PACK_STRUCT_FIELD(TUInt8 blueShift); /** and blue */

    PACK_STRUCT_FIELD(TUInt8 pad1);
    PACK_STRUCT_FIELD(TUInt16 pad2);
}PACK_STRUCT_STRUCT rfbPixelFormat;
PACK_STRUCT_END
 ...
 *
 * It is intended that both clients and serversDbInfo may provide some level of
...
// VM Pilot does no not have leading formating
// #define rfbProtocolVersionFormat "RFB %03d.%03d\n"

#define rfbProtocolVersionFormat "RFB 00%d.00%d\n"
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt32 nameLength);
/** followed by char name[nameLength] */
} PACK_STRUCT_STRUCT rfbServerInitMsg;
PACK_STRUCT_END
...
} PACK_STRUCT_STRUCT rfbFramebufferUpdateMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt8 h);
} PACK_STRUCT_STRUCT rfbCoRRERectangle;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt16 nColours);

/** Followed by nColours * 3 * TUInt16
 r1, g1, b1, r2, g2, b2, r3, g3, b3, ..., rn, bn, gn */

} PACK_STRUCT_STRUCT rfbSetColourMapEntriesMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt8 pad1);
        PACK_STRUCT_FIELD(TUInt16 pad2);
        PACK_STRUCT_FIELD(TUInt32 length);
/** followed by char text[length] */
} PACK_STRUCT_STRUCT rfbServerCutTextMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt16 desktop_h); /** Desktop height */
        PACK_STRUCT_FIELD(TUInt16 buffer_w); /** FrameBuffer width */
        PACK_STRUCT_FIELD(TUInt16 buffer_h); /** Framebuffer height */
        PACK_STRUCT_FIELD(TUInt16 pad2);
} PACK_STRUCT_STRUCT rfbReSizeFrameBufferMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt8 pad1);
        PACK_STRUCT_FIELD(TUInt16 pad2);
        PACK_STRUCT_FIELD(rfbPixelFormat format);
} PACK_STRUCT_STRUCT rfbSetPixelFormatMsg;
PACK_STRUCT_END

#define sz_rfbSetPixelFormatMsg (sz_rfbPixelFormat + 4)

/**-----------------------------------------------------------------------------
 * VNCSetScaleFactor - tell the RFB server to alter the scale factor for the
 * client buffer.
 */
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt16 pad2);
} PACK_STRUCT_STRUCT rfbSetScaleFactorMsg;
PACK_STRUCT_END
...
/** Followed by nColours * 3 * TUInt16
 r1, g1, b1, r2, g2, b2, r3, g3, b3, ..., rn, bn, gn */
} PACK_STRUCT_STRUCT rfbFixColourMapEntriesMsg;
PACK_STRUCT_END
...
/** followed by nEncodings * TUInt32 encoding types */
} PACK_STRUCT_STRUCT rfbSetEncodingsMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt16 w);
        PACK_STRUCT_FIELD(TUInt16 h);
} PACK_STRUCT_STRUCT rfbFramebufferUpdateRequestMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt32 key); /** key is specified as an X keysym */
} PACK_STRUCT_STRUCT rfbKeyEventMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt16 x);
        PACK_STRUCT_FIELD(TUInt16 y);
} PACK_STRUCT_STRUCT rfbPointerEventMsg;
PACK_STRUCT_END
...
typedef struct {
        ...
        PACK_STRUCT_FIELD(TUInt32 length);
/** followed by char text[length] */
} PACK_STRUCT_STRUCT rfbClientCutTextMsg;
PACK_STRUCT_END
