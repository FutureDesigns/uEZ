...
const char * LISTBOX__GetpStringLocked      (LISTBOX_Handle hObj, int32_t Index, LISTBOX_ITEM ** ppItem);
void         LISTBOX__InvalidateInsideArea  (LISTBOX_Handle hObj);
void         LISTBOX__InvalidateItem        (LISTBOX_Handle hObj, int32_t Sel);
void         LISTBOX__InvalidateItemAndBelow(LISTBOX_Handle hObj, int32_t Sel);
...
void         LISTBOX__AddSize               (LISTBOX_Obj * pObj, int32_t Index);
