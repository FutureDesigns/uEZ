...
LISTBOX_Handle LISTBOX_Create        (const GUI_ConstString * ppText, int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, int32_t Flags);
LISTBOX_Handle LISTBOX_CreateAsChild (const GUI_ConstString * ppText, WM_HWIN hWinParent, int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, int32_t Flags);
LISTBOX_Handle LISTBOX_CreateEx      (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t ExFlags, int32_t Id, const GUI_ConstString * ppText);
LISTBOX_Handle LISTBOX_CreateUser    (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t ExFlags, int32_t Id, const GUI_ConstString * ppText, int32_t NumExtraBytes);
LISTBOX_Handle LISTBOX_CreateIndirect(const GUI_WIDGET_CREATE_INFO * pCreateInfo, WM_HWIN hWinParent, int32_t x0, int32_t y0, WM_CALLBACK * cb);
...
int32_t              LISTBOX_AddKey           (LISTBOX_Handle hObj, int32_t Key);
...
void             LISTBOX_EnableWrapMode   (LISTBOX_Handle hObj, int32_t OnOff);
...
int32_t              LISTBOX_GetSel           (LISTBOX_Handle hObj);
GUI_COLOR        LISTBOX_GetTextColor     (LISTBOX_Handle hObj, unsigned Index);
int32_t              LISTBOX_GetItemDisabled  (LISTBOX_Handle hObj, unsigned Index);
int32_t              LISTBOX_GetItemSel       (LISTBOX_Handle hObj, unsigned Index);
void             LISTBOX_GetItemText      (LISTBOX_Handle hObj, unsigned Index, char * pBuffer, int32_t MaxSize);
int32_t              LISTBOX_GetMulti         (LISTBOX_Handle hObj);
WM_HWIN          LISTBOX_GetOwner         (LISTBOX_Handle hObj);
int32_t              LISTBOX_GetScrollStepH   (LISTBOX_Handle hObj);
int32_t              LISTBOX_GetTextAlign     (LISTBOX_Handle hObj);
int32_t              LISTBOX_GetUserData      (LISTBOX_Handle hObj, void * pDest, int32_t NumBytes);
void             LISTBOX_IncSel           (LISTBOX_Handle hObj);
void             LISTBOX_InsertString     (LISTBOX_Handle hObj, const char * s, unsigned Index);
void             LISTBOX_InvalidateItem   (LISTBOX_Handle hObj, int32_t Index);
int32_t              LISTBOX_OwnerDraw        (const WIDGET_ITEM_DRAW_INFO * pDrawItemInfo);
void             LISTBOX_SetAutoScrollH   (LISTBOX_Handle hObj, int32_t OnOff);
void             LISTBOX_SetAutoScrollV   (LISTBOX_Handle hObj, int32_t OnOff);
...
void             LISTBOX_SetItemDisabled  (LISTBOX_Handle hObj, unsigned Index, int32_t OnOff);
void             LISTBOX_SetItemSel       (LISTBOX_Handle hObj, unsigned Index, int32_t OnOff);
void             LISTBOX_SetItemSpacing   (LISTBOX_Handle hObj, unsigned Value);
void             LISTBOX_SetMulti         (LISTBOX_Handle hObj, int32_t Mode);
...
void             LISTBOX_SetScrollStepH   (LISTBOX_Handle hObj, int32_t Value);
void             LISTBOX_SetSel           (LISTBOX_Handle hObj, int32_t Sel);
...
void             LISTBOX_SetTextAlign     (LISTBOX_Handle hObj, int32_t Align);
GUI_COLOR        LISTBOX_SetTextColor     (LISTBOX_Handle hObj, unsigned Index, GUI_COLOR Color);
int32_t              LISTBOX_SetUserData      (LISTBOX_Handle hObj, const void * pSrc, int32_t NumBytes);
int32_t              LISTBOX_UpdateScrollers  (LISTBOX_Handle hObj);
