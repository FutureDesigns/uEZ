...
*/
static void _FillRectOpt8(GUI_DEVICE * pDevice, int32_t x0, int32_t y0, int32_t x1, int32_t y1) {
  DRIVER_CONTEXT * pContext;
  U32 Data, ColorMask, AndMask, Off0, OffLine;
  int32_t NumPixel_0, NumPixel_1, RemPixels, NumLines, RemLines, RemItems;
