...
**********************************************************************
*/
KNOB_Handle KNOB_CreateEx      (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t Id);
KNOB_Handle KNOB_CreateUser    (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t Id, int32_t NumExtraBytes);
KNOB_Handle KNOB_CreateIndirect(const GUI_WIDGET_CREATE_INFO * pCreateInfo, WM_HWIN hWinParent, int32_t x0, int32_t y0, WM_CALLBACK * cb);
...
int32_t  KNOB_GetUserData(KNOB_Handle hObj, void * pDest, int32_t NumBytes);               // Gets user defined data
...
int32_t  KNOB_SetUserData(KNOB_Handle hObj, const void * pSrc, int32_t NumBytes);          // Sets user defined data
