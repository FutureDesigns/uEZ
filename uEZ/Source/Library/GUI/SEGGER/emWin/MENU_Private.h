...
**********************************************************************
*/
int32_t       MENU__CalcMenuSizeX         (MENU_Handle hObj);
int32_t       MENU__CalcMenuSizeY         (MENU_Handle hObj);
int32_t       MENU__FindItem              (MENU_Handle hObj, U16 ItemId, MENU_Handle* phMenu);
int32_t       MENU__GetEffectSize         (MENU_Handle hObj);
int32_t       MENU__GetItemHeight         (MENU_Handle hObj, unsigned Index);
int32_t       MENU__GetItemWidth          (MENU_Handle hObj, unsigned Index);
unsigned  MENU__GetNumItems           (MENU_Obj * pObj);
int32_t       MENU__HasEffect             (MENU_Handle hObj, MENU_Obj * pObj);
...
int32_t       MENU__SendMenuMessage       (MENU_Handle hObj, WM_HWIN hDestWin, U16 MsgType, U16 ItemId);
