...
typedef struct {
  ...
  int32_t                     PosTouchedLast;   // Last touched position in pixels
  int32_t                     Pos;              // Current position in pixels
  int32_t                     Velocity;         // Motion in pixels
  int32_t                     SnapPosition;     // Snap position in pixels
  int32_t                     TouchPos;         // Y-position of last touch event
  int32_t                     ySizeData;        // Data size in pixels
  int32_t                     Destination;      // Destination position in pixels
...
**********************************************************************
*/
const char * LISTWHEEL__GetpStringLocked(LISTWHEEL_Handle hObj, int32_t Index, LISTWHEEL_ITEM ** ppItem);
