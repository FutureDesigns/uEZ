...
typedef struct {
  ...
  void (* pfSendCache)  (DRIVER_CONTEXT * pContext, int32_t x0, int32_t y0, int32_t x1, int32_t y1);
  U32  (* pfXY2Off)     (DRIVER_CONTEXT * pContext, int32_t x, int32_t y);
  //
...
struct DRIVER_CONTEXT {
  ...
  int32_t FirstSEG;
  int32_t FirstCOM;
  int32_t UseMirror;   // Used by SSD1848
  int32_t CheckBusy;   // Used by T6963
  ...
  //
  int32_t  (* pfControlCache)(GUI_DEVICE *  pDevice, int32_t Cmd);
...
**********************************************************************
*/
void (*GUIDRV__SLin_GetDevFunc(GUI_DEVICE ** ppDevice, int32_t Index))(void);
void   GUIDRV__SLin_SetOrg    (GUI_DEVICE *  pDevice,  int32_t x, int32_t y);
I32    GUIDRV__SLin_GetDevProp(GUI_DEVICE *  pDevice,  int32_t Index);
void   GUIDRV__SLin_GetRect   (GUI_DEVICE *  pDevice,  LCD_RECT * pRect);

void   GUIDRV__SLin_SendCache (DRIVER_CONTEXT * pContext, int32_t x0, int32_t y0, int32_t x1, int32_t y1);
void   GUIDRV__SLin_WriteVMEM (DRIVER_CONTEXT * pContext, U32 Off, U8 Data, int32_t x, int32_t y);
