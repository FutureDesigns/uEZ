...
**********************************************************************
*/
SWIPELIST_Handle SWIPELIST_CreateAsChild  (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t Id, int32_t Flags);
SWIPELIST_Handle SWIPELIST_CreateEx       (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t ExFlags, int32_t Id);
SWIPELIST_Handle SWIPELIST_CreateIndirect (const GUI_WIDGET_CREATE_INFO * pCreateInfo, WM_HWIN hWinParent, int32_t x0, int32_t y0, WM_CALLBACK * cb);
SWIPELIST_Handle SWIPELIST_CreateUser     (int32_t x0, int32_t y0, int32_t xSize, int32_t ySize, WM_HWIN hParent, int32_t WinFlags, int32_t ExFlags, int32_t Id, int32_t NumExtraBytes);
...
int32_t                SWIPELIST_AddItem                 (SWIPELIST_Handle hObj, const char * sText, int32_t ItemSize);
int32_t                SWIPELIST_AddItemText             (SWIPELIST_Handle hObj, unsigned ItemIndex, const char * sText);
int32_t                SWIPELIST_AddSepItem              (SWIPELIST_Handle hObj, const char * sText, int32_t ItemSize);
...
int32_t                SWIPELIST_GetBitmapSpace          (SWIPELIST_Handle hObj);
GUI_COLOR          SWIPELIST_GetBkColor              (SWIPELIST_Handle hObj, unsigned Index);
int32_t                SWIPELIST_GetBorderSize           (SWIPELIST_Handle hObj, unsigned Index);
const GUI_FONT *   SWIPELIST_GetFont                 (SWIPELIST_Handle hObj, unsigned Index);
int32_t                SWIPELIST_GetItemSize             (SWIPELIST_Handle hObj, unsigned ItemIndex);
U32                SWIPELIST_GetItemUserData         (SWIPELIST_Handle hObj, unsigned ItemIndex);
int32_t                SWIPELIST_GetNumItems             (SWIPELIST_Handle hObj);
int32_t                SWIPELIST_GetNumText              (SWIPELIST_Handle hObj, unsigned ItemIndex);
int32_t                SWIPELIST_GetReleasedItem         (SWIPELIST_Handle hObj);
int32_t                SWIPELIST_GetScrollPos            (SWIPELIST_Handle hObj);
int32_t                SWIPELIST_GetSelItem              (SWIPELIST_Handle hObj);
GUI_COLOR          SWIPELIST_GetSepColor             (SWIPELIST_Handle hObj, unsigned ItemIndex);
int32_t                SWIPELIST_GetSepSize              (SWIPELIST_Handle hObj, unsigned ItemIndex);
void               SWIPELIST_GetText                 (SWIPELIST_Handle hObj, unsigned ItemIndex, unsigned TextIndex, char * pBuffer, int32_t MaxSize);
int32_t                SWIPELIST_GetTextAlign            (SWIPELIST_Handle hObj, unsigned ItemIndex);
GUI_COLOR          SWIPELIST_GetTextColor            (SWIPELIST_Handle hObj, unsigned Index);
int32_t                SWIPELIST_GetThreshold            (SWIPELIST_Handle hObj);
int32_t                SWIPELIST_GetUserData             (SWIPELIST_Handle hObj, void * pDest, int32_t NumBytes);

int32_t                SWIPELIST_ItemAttachWindow        (SWIPELIST_Handle hObj, unsigned ItemIndex, WM_HWIN hWin, int32_t x0, int32_t y0);
void               SWIPELIST_ItemDetachWindow        (SWIPELIST_Handle hObj, WM_HWIN hWin);
int32_t                SWIPELIST_OwnerDraw               (const WIDGET_ITEM_DRAW_INFO * pDrawItemInfo);

void               SWIPELIST_SetAttachedWindowPos    (SWIPELIST_Handle hObj, WM_HWIN hWin, int32_t x0, int32_t y0);
void               SWIPELIST_SetBitmap               (SWIPELIST_Handle hObj, unsigned ItemIndex, int32_t Align, const GUI_BITMAP * pBitmap);
void               SWIPELIST_SetBitmapEx             (SWIPELIST_Handle hObj, unsigned ItemIndex, int32_t Align, const GUI_BITMAP * pBitmap, int32_t x, int32_t y);
...
void               SWIPELIST_SetScrollPos            (SWIPELIST_Handle hObj, int32_t Pos);
...
void               SWIPELIST_SetSepSize              (SWIPELIST_Handle hObj, unsigned ItemIndex, int32_t Size);
void               SWIPELIST_SetText                 (SWIPELIST_Handle hObj, unsigned ItemIndex, unsigned TextIndex, char * sText);
void               SWIPELIST_SetTextAlign            (SWIPELIST_Handle hObj, unsigned ItemIndex, int32_t Align);
void               SWIPELIST_SetTextColor            (SWIPELIST_Handle hObj, unsigned Index, GUI_COLOR Color);
int32_t                SWIPELIST_SetThreshold            (SWIPELIST_Handle hObj, int32_t Threshold);
int32_t                SWIPELIST_SetUserData             (SWIPELIST_Handle hObj, const void * pSrc, int32_t NumBytes);
...
**********************************************************************
*/
int32_t              SWIPELIST_GetDefaultBitmapSpace     (void);
GUI_COLOR        SWIPELIST_GetDefaultBkColor         (unsigned Index);
int32_t              SWIPELIST_GetDefaultBorderSize      (unsigned Index);
...
int32_t              SWIPELIST_GetDefaultTextAlign       (void);
int32_t              SWIPELIST_GetDefaultThreshold       (void);
...
void             SWIPELIST_SetDefaultTextAlign       (int32_t Align);
void             SWIPELIST_SetDefaultThreshold       (int32_t Threshold);
