...
#include "mbedtls_config.h" // default configuration file in uEZ/Include folder.
#else
#include MBEDTLS_CONFIG_FILE // use this macro to specify project specifc config file.
#endif
