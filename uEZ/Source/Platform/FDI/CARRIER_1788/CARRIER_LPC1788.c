...
void UEZPlatform_LCD_Require(void)
{
    ...
    LCD_RH320240T_Create("LCD", "SSP0", GPIO_P2_11);
#elif (UEZ_DEFAULT_LCD_CONFIG==LCD_CONFIG_KOE_TX13D06VM2BAA)
    LCD_TX13D06VM2BAA_Create("LCD", GPIO_P2_4, GPIO_P2_0, GPIO_p2_11);
#endif
}
...
void UEZPlatform_AudioAmp_Require(void)
{
    ...
    // P2.14 = VOL_UD
    // P2.15 = AMP_MODE
    AudioAmp_8551T_Create("AMP0", GPIO_P2_14, GPIO_P2_15, GPIO_NONE);
