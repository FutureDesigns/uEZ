...
%CROSSBUILD% -verbose -threadnum 4 -config ReleaseOptForSize "Build\Generic\NXP\LPC4357\FreeRTOS\CrossWorks\uEZ_NXP_LPC4357_FreeRTOS_CrossWorks.hzp"
%CROSSBUILD% -verbose -threadnum 4 -config "Debug CLANG" "Build\Generic\NXP\LPC4357\FreeRTOS\CrossWorks\uEZ_NXP_LPC4357_FreeRTOS_CrossWorks.hzp"
pause
