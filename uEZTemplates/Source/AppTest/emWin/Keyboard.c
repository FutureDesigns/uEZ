...
//Text filed height
#define KEYBOARD_G_textBox_HEIGHT       (KEYBOARD_BUTTON_HEIGHT / 2)
...
#define KEYBOARD_BACKGROUND_COLOR           GUI_BLACK
#define KEY_BACKGROUND_COLOR_PRESSED        GUI_GRAY
#define KEY_BACKGROUND_COLOR                GUI_DARKGRAY
#define KEY_FONT_COLOR                      GUI_WHITE
    ...
    switch (pMsg->MsgId) {
        case WM_INIT_DIALOG:
            ...
            while (p->iID) {
                ...
                BUTTON_SetTextColor(hItem, BUTTON_CI_UNPRESSED, KEY_FONT_COLOR);
                BUTTON_SetTextColor(hItem, BUTTON_CI_PRESSED, KEY_FONT_COLOR);
                BUTTON_SetBkColor(hItem, BUTTON_CI_UNPRESSED,
                    KEY_BACKGROUND_COLOR);
                BUTTON_SetBkColor(hItem, BUTTON_CI_PRESSED, KEY_BACKGROUND_COLOR_PRESSED);
