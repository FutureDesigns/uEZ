 ...
 * Constants:
 *-------------------------------------------------------------------------*/
const BUTTON_SKINFLEX_PROPS pressedButtonProps = {
    { GUI_BLACK, GUI_BLACK, GUI_BLACK },
    { GUI_BLACK, GUI_BLACK },
    { GUI_BLACK, GUI_BLACK },
    0, };

const BUTTON_SKINFLEX_PROPS unPressedButtonProps = {
    { GUI_BLACK, GUI_BLACK, GUI_BLACK },
    { GUI_BLACK, GUI_BLACK },
    { GUI_BLACK, GUI_BLACK },
    0, };
...
/*---------------------------------------------------------------------------*
 * Routine:  LAFSetupEditBox
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the Edit Box properties
 * Inputs:
 *      T_LAFMapping *p -- Mapping of the dialog that holds the
 *                             properties.
 *      WH_HWIN hItem -- handle to the item to be set.
 *---------------------------------------------------------------------------*/
void LAFSetupEditBox(const T_LAFMapping *p, WM_HWIN hItem)
{
    EDIT_SetFont(hItem, p->iFont);
    EDIT_SetTextColor(hItem, EDIT_CI_ENABLED, p->iFontColor);
    EDIT_SetBkColor(hItem, EDIT_CI_ENABLED, p->iColor );
