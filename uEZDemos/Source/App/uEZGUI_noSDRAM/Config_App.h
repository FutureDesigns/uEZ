...
#define HEAP_ENABLED_ON_EXTERNAL_RAM       0
...
#define MAIN_TASK_STACK_SIZE        UEZ_TASK_STACK_BYTES((2*1024)+256)
...
#define MAX_NUM_FRAMES          0 // for largest screen uezgui frames memory = (800*480*(8+3)+1024*576)/1024/1024 = 4.60MB
