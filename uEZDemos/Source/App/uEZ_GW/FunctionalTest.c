...
static const T_gpioMapping G_gpioMapping[] = {
	//EXP and PMOD Header Pins
    #define FCTPIN_P5_3        (1<<0) //J6_3
    { 5,   3, "P5[3]" },
    #define FCTPIN_P5_4        (1<<1)
    { 5,   4, "P5[4]" },
    #define FCTPIN_P2_4         (1<<2)
    { 2,   4,  "P2[4]"  },
//    #define FCTPIN_P4_8         (1<<3) (UART)
//    { 4,   8,  "P4[8]"  },
//    #define FCTPIN_P4_9         (1<<4)
//    { 4,   9,  "P4[9]"  },
    #define FCTPIN_P6_10         (1<<5)
    { 6,   10,  "P6[10]"  },
    #define FCTPIN_P6_24         (1<<6)
    { 6,   24,  "P6[24]" },
    #define FCTPIN_P6_11        (1<<7)
    { 6,   11, "P6[11]" },
    #define FCTPIN_P5_5         (1<<8)
    { 5,   5,  "P5[5]"  },
    #define FCTPIN_P3_12         (1<<9)
    { 3,   12,  "P3[12]"  },
    #define FCTPIN_P3_13         (1<<10)
    { 3,   13,  "P3[13]"  },
    #define FCTPIN_P7_21        (1<<11)
    { 7,   21, "P7[21]" },
    #define FCTPIN_P7_20        (1<<12)
    { 7,   20, "P7[20]" },
    #define FCTPIN_P4_10        (1<<13)
    { 4,   10, "P4[10]" },
    #define FCTPIN_P7_19        (1<<14)
    { 7,   19,  "P7[19]"  },
    #define FCTPIN_P2_1        (1<<15)
    { 2,   1, "P2[1]" },
    
    //XBEE Pins
    #define FCTPIN_P6_13        (((TUInt64)1)<<16)
    { 6,   13,    "P6[13]" },
    #define FCTPIN_P6_12        (((TUInt64)1)<<17)
    { 6,   12,    "P6[12]" },
    #define FCTPIN_P7_17        (((TUInt64)1)<<18)
    { 7,   17,    "P7[17]" },    
    #define FCTPIN_P7_4        (((TUInt64)1)<<19) // 7-4 output only
    { 7,   4,    "P7[4]" }, 
    #define FCTPIN_P7_2        (((TUInt64)1)<<20)
    { 7,   2,    "P7[2]" },
    
    #define FCTPIN_P7_3        (((TUInt64)1)<<21)
    { 7,   3,    "P7[3]" },
    #define FCTPIN_P4_1        (((TUInt64)1)<<22)
    { 4,   1,    "P4[1]" },
    #define FCTPIN_P7_16        (((TUInt64)1)<<23)
    { 7,    16,   "P7[16]" },
    #define FCTPIN_P6_2        (((TUInt64)1)<<24)
    { 6,    2,   "P6[2]" },
    #define FCTPIN_P6_25        (((TUInt64)1)<<25)
    { 6,    25,   "P6[25]" },
    #define FCTPIN_P6_1        (((TUInt64)1)<<26)
    { 6,    1,   "P6[1]" },
    #define FCTPIN_P7_18        (((TUInt64)1)<<27)
    { 7,    18,   "P7[18]" },
};

const T_gpioTestEntry G_gpioTestArray[] = {
    { FCTPIN_P5_3,         FCTPIN_P6_13,               "P5[3] -> P6[13]" },
    { FCTPIN_P5_4,         FCTPIN_P6_12,                "P5[4] -> P6[12]" },
    { FCTPIN_P2_4,          FCTPIN_P7_17,                "P2[4]  -> P7[17]" },
    { FCTPIN_P6_10,          FCTPIN_P7_2,                "P6[10]  -> P7[2]" },
    { FCTPIN_P3_12,          FCTPIN_P4_1,               "P3[12]  -> P4[1]" },
    { FCTPIN_P7_21,          FCTPIN_P6_2,               "P7[21]  -> P6[2]" },    
    { FCTPIN_P4_10,          FCTPIN_P7_16,              "P4[10]  -> P7[16]" },
    { FCTPIN_P7_19,         FCTPIN_P6_1,               "P7[19] -> P6[1]" },
    { FCTPIN_P6_1,         FCTPIN_P7_19,               "P6[1] -> P7[19]" },
    { FCTPIN_P7_16,         FCTPIN_P4_10,                "P7[16] -> P4[10]" },
    { FCTPIN_P6_2,          FCTPIN_P7_21,                "P6[42]  -> P7[21]" },
    { FCTPIN_P4_1,          FCTPIN_P3_12,                "P4[1]  -> P3[12]" },
    { FCTPIN_P7_2,          FCTPIN_P6_10,               "P7[2]  -> P6[10]" },
    { FCTPIN_P7_17,          FCTPIN_P2_4,               "P7[17]  -> P2[4]" },    
    { FCTPIN_P6_12,          FCTPIN_P5_4,		 "P6[12]  -> P5[4]" },
    { FCTPIN_P6_13,         FCTPIN_P5_3,               "P6[13] -> P5[3]" },
};

const T_gpioTestEntry G_gpioTestArrayEXP[] = {
    { FCTPIN_P5_3,         FCTPIN_P6_13,               "P5[3] -> P6[13]" },
    { FCTPIN_P5_4,         FCTPIN_P6_12,                "P5[4] -> P6[12]" },
    { FCTPIN_P2_4,          FCTPIN_P7_17,                "P2[4]  -> P7[17]" },
    { FCTPIN_P6_10,          FCTPIN_P7_2,                "P6[10]  -> P7[2]" },
...
const T_gpioTestEntry G_gpioTestArrayXBEE[] = {
    { FCTPIN_P6_13,     FCTPIN_P7_3,    "P6[13]  -> P7[3]" },    
    { FCTPIN_P7_3,      FCTPIN_P6_13,   "P7[3]  -> P6[13]" },    
    
    { FCTPIN_P6_12,     FCTPIN_P4_1,    "P6[12]  -> P4[1]" },
    { FCTPIN_P4_1,      FCTPIN_P6_12,   "P4[1]  -> P6[12]" }, // fails
    
    //{ FCTPIN_P7_16,     FCTPIN_P7_17,   "P7[16]  -> P7[17]" }, // fails
    //{ FCTPIN_P7_17,     FCTPIN_P7_16,   "P7[17]  -> P6[16]" }, // fails
    
    //{ FCTPIN_P7_4,      FCTPIN_P6_2,    "P7[4]  -> P6[2]" }, // only other way should work
    //{ FCTPIN_P6_2,      FCTPIN_P7_4,    "P6[2]  -> P7[4]" }, // only this way should work
    
    //{ FCTPIN_P7_2,      FCTPIN_P7_18,   "P7[2]  -> P7[18]" },
    //{ FCTPIN_P7_18,     FCTPIN_P7_2,    "P7[18]  -> P7[2]" },
    
    //{ FCTPIN_P6_25,     FCTPIN_P6_1,    "P6[25]  -> P6[1]" },    
    //{ FCTPIN_P6_1,      FCTPIN_P6_25,   "P6[1]  -> P6[25]" },
};

const T_gpioTestEntry G_gpioTestArrayPMOD[] = { // done, needs test 
    //{ FCTPIN_P5_4,         FCTPIN_P7_19,               "P5[4]  -> P7[19]" }, // cannot get any to work!
    //{ FCTPIN_P5_3,         FCTPIN_P7_21,               "P5[3]  -> P7[21]" },
    { FCTPIN_P6_24,        FCTPIN_P7_20,               "P6[24] -> P7[20]" },
    // 
    //{ FCTPIN_P7_19,        FCTPIN_P5_4,                "P7[19] -> P5[4]" },
    //{ FCTPIN_P7_21,        FCTPIN_P5_3,                "P7[21] -> P5[3]" },
    { FCTPIN_P7_20,        FCTPIN_P6_24,               "P7[20] -> P6[24]" },
};
...
void FuncTestXBEE(const T_testAPI *aAPI, T_testData *aData, TUInt16 aButton)
{
    ...
    T_RSSITest *p = (T_RSSITest *)aData->iData;    
    T_uezDevice adc;
    T_uezError error;
    ADC_RequestSingle r = {0};
    TUInt32 reading = 0;
    TUInt32 percent = 0;
    ...
    if (aButton == OPT_INIT) {
        ...
        // read ADC0_6, should be zero
        error = UEZADCOpen("ADC0", &adc);
        if (error) {
            aAPI->iTextLine(aData, 0, "RSSI ADC not Found!");
            ...
            // make sure ADC loopback reads 0
            UEZGPIOOutput(GPIO_P6_25); 
            UEZGPIOSetMux(GPIO_P6_25, (GPIO_P6_25 >> 8) >= 5 ? 4 : 0);
            value = ((GPIO_P6_25 >> 8) & 0x7) >= 5 ? 4 : 0;
            UEZGPIOControl(GPIO_P6_25, GPIO_CONTROL_SET_CONFIG_BITS, value);
            UEZGPIOClear(GPIO_P6_25);    

            UEZGPIOOutput(GPIO_P6_1); 
            UEZGPIOSetMux(GPIO_P6_1, (GPIO_P6_1 >> 8) >= 5 ? 4 : 0);
            value = ((GPIO_P6_1 >> 8) & 0x7) >= 5 ? 4 : 0;
            UEZGPIOControl(GPIO_P6_1, GPIO_CONTROL_SET_CONFIG_BITS, value);
            UEZGPIOClear(GPIO_P6_1);    
                
            // Take a reading
            error = UEZADCRequestSingle(adc, &r);
            if (error) {
            aAPI->iTextLine(aData, 0, "RSSI ADC bad reading!");
            aAPI->iShowResult(aData, 0, TEST_RESULT_FAIL, 0);
            aAPI->iSetTestResult(aData, TEST_RESULT_FAIL);
            sprintf(aData->iResultValue, "No Reading");
            } else { //
            percent = reading * 100 / 0x3FF;
            sprintf(p->iLine, "RSSI (%d %%)", percent);
            ...
            if (percent > 20) {
              ...
              aAPI->iShowResult(aData, 0, TEST_RESULT_FAIL, 0);
              aAPI->iSetTestResult(aData, TEST_RESULT_FAIL);
              sprintf(aData->iResultValue, "RSSI circuit bad");
            } else {
              //  aAPI->iShowResult(aData, 0, TEST_RESULT_PASS, 0);
              //  aAPI->iSetTestResult(aData, TEST_RESULT_PASS);
            }
            }
            UEZGPIOSet(GPIO_P6_25);
            UEZGPIOSet(GPIO_P6_1);
            
            // read ADC0_6, should be ~ 3.2V
            error = UEZADCRequestSingle(adc, &r);
            if (error) {
            aAPI->iTextLine(aData, 0, "RSSI ADC bad reading!");
            aAPI->iShowResult(aData, 0, TEST_RESULT_FAIL, 0);
    ...
    printf("pinAr %u\n", ARRAY_COUNT(G_gpioTestArrayXBEE));
    FuncTestLoopbacks(aAPI, aData, aButton, G_gpioTestArrayXBEE, ARRAY_COUNT(G_gpioTestArrayXBEE)); // reset pin states
    //FuncTestLoopbacks(aAPI, aData, 0, G_gpioTestArrayXBEE, ARRAY_COUNT(G_gpioTestArrayXBEE));   
    //FuncTestLoopbacks(aAPI, aData, 0, G_gpioTestArrayXBEE, ARRAY_COUNT(G_gpioTestArrayXBEE));
...
{
  TUInt32 value;
  // set certain EXP pins to input mode (should be done with common pin map)
   //2.1 
   //2.4
   //3.13
   //5.5
  ...
  /*TUInt16 t1, t2;
  TUInt32 delay = 1000;
  T_uezGPIOPortPin a = GPIO_P5_4;
  T_uezGPIOPortPin b = GPIO_P7_19;*/
  
  /*

//It can be a little weird because the GPIO function of pins is not always 0 like on the other LPC MCUs, 5 and up are function 4 for GPIO.

// correct for p5 and up, but tweak for P0-4?
    value = (a >> 8) > 4 ? 4 : 0;    
    UEZGPIOControl(a, GPIO_CONTROL_SET_CONFIG_BITS, 
    SCU_NORMAL_DRIVE_DEFAULT(value));
    UEZGPIOInput(a);
    
    value = (b >> 8) > 4 ? 4 : 0;    
    UEZGPIOControl(b, GPIO_CONTROL_SET_CONFIG_BITS, 
    SCU_NORMAL_DRIVE_DEFAULT(value));
    UEZGPIOInput(b);
  ...
  while(1) {
    ...
    UEZGPIOOutput(a); 
    UEZGPIOSetMux(a, (a >> 8) >= 5 ? 4 : 0);
    value = ((a >> 8) & 0x7) >= 5 ? 4 : 0;
    UEZGPIOControl(a, GPIO_CONTROL_SET_CONFIG_BITS, value);
    
    UEZGPIOInput(b); 
    UEZGPIOSetMux(b, (b >> 8) >= 5 ? 4 : 0);
    value = ((b >> 8) & 0x7) >= 5 ? 4 : 0;
    UEZGPIOControl(b, GPIO_CONTROL_SET_CONFIG_BITS, value);
  ...
  //blink led 3 times
    ...
    UEZGPIOOutput(GPIO_P4_12); 
    UEZGPIOSetMux(GPIO_P4_12, (GPIO_P4_12 >> 8) >= 5 ? 4 : 0);
    value = ((GPIO_P4_12 >> 8) & 0x7) >= 5 ? 4 : 0;
    UEZGPIOControl(GPIO_P4_12, GPIO_CONTROL_SET_CONFIG_BITS, value);
    
    UEZGPIOClear(GPIO_P4_12);
    UEZTaskDelay(500);
    UEZGPIOSet(GPIO_P4_12);
    UEZTaskDelay(500);
    ...
    printf("pinAr %u\n", ARRAY_COUNT(G_gpioTestArrayPMOD));
    FuncTestLoopbacks(aAPI, aData, aButton, G_gpioTestArrayPMOD, ARRAY_COUNT(G_gpioTestArrayPMOD)); // test with PMOD pins
}

void FuncTestEXP(const T_testAPI *aAPI, T_testData *aData, TUInt16 aButton)
{  
  // set certain PMOD pins to input mode
  
  //FuncTestLoopbacks(aAPI, aData, aButton, G_gpioTestArrayEXP, ARRAY_COUNT(G_gpioTestArrayEXP)); // test with EXP pins
  
  // set the same pins and EXP pins back to input mode
}
...
//        p->iStart = UEZTickCounterGet();
        ...
        for (pin=0; pin<ARRAY_COUNT(G_gpioMapping); pin++) {
            ...
            //(*p_port)->SetMux(p_port, p_pin->iMapPin, (p_pin->iMapPort >> 8) >= 5 ? 4 : 0);
            //value = ((UEZ_GPIO_PORT_PIN(p_pin->iMapPort,p_pin->iMapPin) >> 8) & 0x7) >= 5 ? 4 : 0;
        ...
        if (p->iState < testArraySize) {
            p_test = &testArray[p->iState++];
            ...
            for (pin=0; pin<ARRAY_COUNT(G_gpioMapping); pin++) {
                ...
                if (p_test->iPinsDrive & (((TUInt64)1)<<pin)) {
                    ...
                    (*p_port)->SetOutputMode(p_port, 1<<p_pin->iMapPin); // set to Output
                      ...
                      value = ((UEZ_GPIO_PORT_PIN(p_pin->iMapPort,p_pin->iMapPin) >> 8) > 4 ? 4 : 0);
                      UEZGPIOControl(UEZ_GPIO_PORT_PIN(p_pin->iMapPort,p_pin->iMapPin), GPIO_CONTROL_SET_CONFIG_BITS, 
                      SCU_NORMAL_DRIVE_DEFAULT(value));
                      //UEZGPIOInput(b);
...
{
    FuncTestLoopbacks(aAPI, aData, aButton, G_gpioTestArray, ARRAY_COUNT(G_gpioTestArray));
  /*
    typedef struct {
        char iLine[80];
        TUInt32 iState;
