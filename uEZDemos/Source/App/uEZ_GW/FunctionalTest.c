...
//    { 4,   9,  "P4[9]"  },
    ...
    { 7,   17,    "P7[17]" },
    #define FCTPIN_P7_2        (((TUInt64)1)<<19)
    { 7,   2,    "P7[2]" },
    #define FCTPIN_P4_1        (((TUInt64)1)<<20)
    { 4,   1,    "P4[1]" },
    #define FCTPIN_P7_16        (((TUInt64)1)<<21)
    { 7,    16,   "P7[16]" },
    #define FCTPIN_P6_2        (((TUInt64)1)<<22)
    { 6,    2,   "P6[2]" },
    #define FCTPIN_P6_1        (((TUInt64)1)<<23)
    { 6,    1,   "P6[1]" },    
};
