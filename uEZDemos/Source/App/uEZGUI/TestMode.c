...
#elif ((UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD43480272MF) | (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD50800480TF) | (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD50800480TF_Rev2))
       static const T_uezTSReading G_expectedReadings[5] = {
       { 0,    0+TP_INSET,                 TP_INSET,                   1 }, // 0
       { 0,    DISPLAY_WIDTH-TP_INSET,     TP_INSET,                   1 }, // 1
       { 0,    0+TP_INSET,                 DISPLAY_HEIGHT-TP_INSET,    1 }, // 2
