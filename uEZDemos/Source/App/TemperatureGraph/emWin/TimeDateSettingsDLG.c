...
#define WINDOW_XSIZE            (400)//previously defined as (UEZ_LCD_DISPLAY_WIDTH / 2), the new method works better for scaling
#define WINDOW_YSIZE            (240)//previously defined as (UEZ_LCD_DISPLAY_HEIGHT / 2), the new method works better for scaling
#define WINDOW_XPOS             ((UEZ_LCD_DISPLAY_WIDTH / 2) - (WINDOW_XSIZE / 2))
#define WINDOW_YPOS             ((UEZ_LCD_DISPLAY_HEIGHT / 2) - (WINDOW_YSIZE / 2))

#define TITLE_XPOS				(WINDOW_XSIZE/4)
...
#define CLOSE_XSIZE             (50)
#define CLOSE_YSIZE             (20)
#define CLOSE_XPOS              ((WINDOW_XSIZE- CLOSE_XSIZE)-SPACING)
#define CLOSE_YPOS              (WINDOW_YSIZE - CLOSE_YSIZE - SPACING)
...
#define TIMEDATE_BUTTON_XSIZE	(30)
#define TIMEDATE_BUTTON_YSIZE	(30)
...
static const GUI_WIDGET_CREATE_INFO _iTimeDateSettingsDLGDialog[] = {
	...
	{ BUTTON_CreateIndirect		, "UP"			, ID_BUTTON_UP		 ,UP_XPOS				,UP_YPOS				,BUTTON_XSIZE+40	,BUTTON_YSIZE+10,0,	0,	0 },
	{ BUTTON_CreateIndirect		, "DOWN"		, ID_BUTTON_DOWN	 ,DOWN_XPOS				,DOWN_YPOS				,BUTTON_XSIZE+40	,BUTTON_YSIZE+10,0,	0,	0 },
	{ TEXT_CreateIndirect		,"Date:"		, ID_DATELABEL		 ,TITLE_XPOS			,TITLE_YPOS+75			,TITLE_XSIZE		,TITLE_YSIZE,0 ,0 ,0 },
	{ TEXT_CreateIndirect		,":"			, ID_COLON_ONE		 ,TITLE_XPOS*1.35		,TITLE_YPOS+30			,LABEL_SMALL_XSIZE		,LABEL_SMALL_YSIZE,0 ,0 ,0 },
	{ TEXT_CreateIndirect		,":"			, ID_COLON_TWO		 ,TITLE_XPOS*1.85		,TITLE_YPOS+30			,LABEL_SMALL_XSIZE		,LABEL_SMALL_YSIZE,0 ,0 ,0 },
	{ TEXT_CreateIndirect		,"/"			, ID_SLASH_ONE		 ,TITLE_XPOS*1.35		,TITLE_YPOS+105			,LABEL_SMALL_XSIZE		,LABEL_SMALL_YSIZE,0 ,0 ,0 },
	{ TEXT_CreateIndirect		,"/"			, ID_SLASH_TWO		 ,TITLE_XPOS*1.85		,TITLE_YPOS+105			,LABEL_SMALL_XSIZE		,LABEL_SMALL_YSIZE,0 ,0 ,0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_HOUR	 ,TITLE_XPOS			,TITLE_YPOS+30			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_MINUTE	 ,TITLE_XPOS*1.5		,TITLE_YPOS+30			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_SECOND	 ,TITLE_XPOS*2			,TITLE_YPOS+30			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ TEXT_CreateIndirect		, ""			, ID_TEXT_AM_PM		 ,TITLE_XPOS*2.4		,TITLE_YPOS+35			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_MONTH	 ,TITLE_XPOS			,TITLE_YPOS+105			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_DAY		 ,TITLE_XPOS*1.5		,TITLE_YPOS+105			,TIMEDATE_BUTTON_XSIZE	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
	{ BUTTON_CreateIndirect		, ""			, ID_BUTTON_YEAR	 ,TITLE_XPOS*2			,TITLE_YPOS+105			,TIMEDATE_BUTTON_XSIZE*2	,TIMEDATE_BUTTON_YSIZE,0,	0,	0 },
...
static T_LAFMapping TimeDateSettingsDLGMapping[] = {
    { ID_WINDOW     ,""     ,GUI_GRAY, GUI_BLACK, &GUI_Font13_ASCII , LAFSetupWindow, 0},
    { ID_BUTTON_CLOSE   , "X"   , GUI_WHITE     , GUI_BLACK     , &GUI_Font32_ASCII , LAFSetupButton    , IHandleClose},
	...
	{ ID_DATELABEL	, "Date:"	, GUI_GRAY		, GUI_BLACK		, &GUI_Font32B_ASCII , LAFSetupText    , 0},
	{ ID_COLON_ONE	, ":"		,GUI_GRAY		,GUI_BLACK	,&GUI_Font32B_ASCII	,LAFSetupText	,0},
	{ ID_COLON_TWO	, ":"		,GUI_GRAY		,GUI_BLACK	,&GUI_Font32B_ASCII	,LAFSetupText	,0},
	{ ID_SLASH_ONE	, "/"		,GUI_GRAY		,GUI_BLACK	,&GUI_Font32B_ASCII	,LAFSetupText	,0},
	{ ID_SLASH_TWO	, "/"		,GUI_GRAY		,GUI_BLACK	,&GUI_Font32B_ASCII	,LAFSetupText	,0},
	...
	{ ID_TEXT_AM_PM	, ""	, GUI_GRAY		, GUI_BLACK		, &GUI_Font24_ASCII , LAFSetupText , 0},
	...
	{ ID_TIMELABEL	, ""	, GUI_GRAY		, GUI_BLACK		, &GUI_Font32B_ASCII , LAFSetupText    , 0},
...
static TBool IHandleUP(WM_MESSAGE * pMsg, int aNCode, int aID)
{
	...
	if (aNCode == WM_NOTIFICATION_RELEASED) {
		...
		case 4:
			//aTimeDate.iDate.iMonth++;//Increment the current number
			UEZDateNextMonth(&aDate);
			WM_RestartTimer(G_ShowForTimer, SHOW_FOR_TIME_MS);
			break;

		case 5:
			//aTimeDate.iDate.iDay++;//Increment the current number
			UEZDateNextDay(&aDate);
			WM_RestartTimer(G_ShowForTimer, SHOW_FOR_TIME_MS);
			break;

		case 6:
			//aTimeDate.iDate.iYear++;//Increment the current number
 ...
 */
 /*---------------------------------------------------------------------------*/
//void TimeDateSettingsDLG(TBool iAMPM)
