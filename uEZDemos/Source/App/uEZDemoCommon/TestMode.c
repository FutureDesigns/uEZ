                ...
                T_uezDevice ts)
{
...
#if(USE_RESISTIVE_TOUCH==1) // resisitive touchscreens need real ADC coordinates to pass
...
#elif ((UEZ_DEFAULT_LCD_CONFIG==LCD_CONFIG_NEWHAVEN_NHD43480272MF) || (UEZ_DEFAULT_LCD_CONFIG==LCD_CONFIG_NEWHAVEN_NHD43480272MF))
    static const T_uezTSReading G_expectedReadings[5] = {
        { 0,    0x13f6,                     0x58ec,                     1 }, // 0
        { 0,    0x6aa3,                     0x58f0,                     1 }, // 1
        { 0,    0x12d8,                     0x22cd,                     1 }, // 2
...
#else  // if new touchscreen make sure that software still builds
       static const T_uezTSReading G_expectedReadings[5] = {
       { 0,    0+TP_INSET,                 TP_INSET,                   1 }, // 0
       { 0,    DISPLAY_WIDTH-TP_INSET,     TP_INSET,                   1 }, // 1
       { 0,    0+TP_INSET,                 DISPLAY_HEIGHT-TP_INSET,    1 }, // 2
...
#endif // end list of resistive touches

#else //(USE_RESISTIVE_TOUCH==0) PCAP screens here. Most of them use pixel level coordinates
...
#elif ((UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD43480272MF) | (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD43800480CF) | (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD50800480TF) | (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD50800480TF_Rev2)	| (UEZ_DEFAULT_LCD_CONFIG == LCD_CONFIG_NEWHAVEN_NHD70800480EF))
       static const T_uezTSReading G_expectedReadings[5] = {
       { 0,    0+TP_INSET,                 TP_INSET,                   1 }, // 0
       { 0,    DISPLAY_WIDTH-TP_INSET,     TP_INSET,                   1 }, // 1
       { 0,    0+TP_INSET,                 DISPLAY_HEIGHT-TP_INSET,    1 }, // 2
...
#endif // end list of pcap touches

#endif //(USE_RESISTIVE_TOUCH==?)
    ...
    #define READING_X_TOLERANCE         0x1200
    #define READING_Y_TOLERANCE         0x158A
