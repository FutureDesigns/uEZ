...
#define SLIDES_DIRECTORY                    "SLIDES/%s/"
    ...
    #define SLIDESHOW_PICTURE_NAMING        "%sVSLIDE%02u.TGA"
    #define SLIDESHOW_BACKWARDS_COMPATIBLE  0
    #define SLIDESHOW_AUDIO_NAMING        "%sVSLIDE%02u.WAV"
#endif
#if UEZ_DEFAULT_LCD_RES_QVGA
    #define SLIDESHOW_PICTURE_NAMING        "%sQSLIDE%02u.TGA"
    #define SLIDESHOW_BACKWARDS_COMPATIBLE  1
    #define SLIDESHOW_BACKWARD_NAMING       "%sPICTURE%u.TGA"
    #define SLIDESHOW_AUDIO_NAMING        "%sQSLIDE%02u.WAV"
    #define SLIDESHOW_AUDIO_NAMING        "%sQSLIDE%02u.WAV"
#endif
#if UEZ_DEFAULT_LCD_RES_480x272
    #define SLIDESHOW_PICTURE_NAMING        "%sWQSLID%02u.TGA"
    #define SLIDESHOW_BACKWARDS_COMPATIBLE  0
    #define SLIDESHOW_AUDIO_NAMING        "%sWQSLID%02u.WAV"
#endif
#if UEZ_DEFAULT_LCD_RES_WVGA
    #define SLIDESHOW_PICTURE_NAMING        "%sWVSLID%02u.TGA"
    #define SLIDESHOW_BACKWARDS_COMPATIBLE  0
    #define SLIDESHOW_AUDIO_NAMING        "%sWVSLID%02u.WAV"
#endif
