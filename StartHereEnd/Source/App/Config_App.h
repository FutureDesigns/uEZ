...
#define PROJECT_NAME                        "Start Here"
...
#else
#define LCD_FRAMES_START    ((TUInt32 *)0x28000000)
#define LCD_FRAMES_END      ((TUInt32 *)0x285DCFFF)
#define LCD_FRAMES_SIZE     (LCD_FRAMES_END-LCD_FRAME_BUFFER)
// Use hard code location if we don't know what compiler is used
#define LOAD_SPACE ((unsigned char *)0x285DD000)
